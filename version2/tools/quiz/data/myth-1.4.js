...
(function () {
  ...
  const questions = [
    ...
    { id: "1.4-C-20", subtopic: "Theseus: the labours (the Kylix)", q: "On the kylix, how is Theseus shown defeating Sinis?", answers: ["seizing his arm while pulling down the pine tree", "swinging a heavy club down at his head", "hurling him far out into the open sea", "binding him tightly to two bent trees"] },
    { id: "1.4-C-21", subtopic: "Theseus: the labours (the Kylix)", q: "On the kylix, what does Theseus use as a shield against the Crommyonian Sow?", answers: ["his cloak, wrapped around his raised hand", "the lion skin once worn by Heracles", "a bronze rattle made by Hephaistos", "a wooden footstool snatched up nearby"] },
    { id: "1.4-C-22", subtopic: "Theseus: the labours (the Kylix)", q: "Who is the old woman shown beside the sow on the kylix?", answers: ["Phaea, who had reared the sow", "the witch Medea of Colchis", "Ariadne, daughter of Minos", "Athena, the city's goddess"] },
    { id: "1.4-C-23", subtopic: "Theseus: the labours (the Kylix)", q: "On the kylix, what does Theseus swing to strike Sciron?", answers: ["a footstool", "a double axe", "his father's sword", "a flaming torch"] },
    { id: "1.4-C-24", subtopic: "Theseus: the labours (the Kylix)", q: "What creature is shown at the foot of the hill in the Sciron scene?", answers: ["a tortoise", "a giant serpent", "the Minotaur", "a wild boar"] },
    { id: "1.4-C-25", subtopic: "Theseus: the labours (the Kylix)", q: "On the kylix, what objects lean against the wall in the Cercyon scene?", answers: ["a club and a spear", "a sword and a shield", "two bent pine trees", "a bed and an axe"] },
    { id: "1.4-C-26", subtopic: "Theseus: the labours (the Kylix)", q: "On the kylix, what weapon does Theseus swing over Procrustes?", answers: ["a double axe", "a wooden footstool", "a long bronze spear", "a flaming torch"] },
    { id: "1.4-C-27", subtopic: "Theseus: the labours (the Kylix)", q: "On the kylix, how is Theseus shown subduing the Bull of Marathon?", answers: ["riding it, pulling back on a cord tied to its horns", "strangling it tightly from behind it", "stabbing it right through with his sword", "leading it quietly away on a long rope"] },
    { id: "1.4-C-28", subtopic: "Theseus: the labours (the Kylix)", q: "In the central scene, how is Theseus shown with the Minotaur?", answers: ["dragging it from a building by one horn", "kneeling down in prayer before it", "fleeing away out of the Labyrinth", "binding it with Ariadne's ball of wool"] },
    { id: "1.4-C-29", subtopic: "Theseus: the labours (the Kylix)", q: "What did the winner of Cercyon's wrestling match become?", answers: ["king of Eleusis", "king of Athens", "king of Crete", "king of Troezen"] },
    { id: "1.4-C-30", subtopic: "Theseus: the labours (the Kylix)", q: "What was the Minotaur?", answers: ["a creature with a bull's head and a human body", "a man with the body of a wild bull", "a great hound with three heads", "a huge fire-breathing serpent"] },
    { id: "1.4-C-31", subtopic: "Theseus: the labours (the Kylix)", q: "Where was the Minotaur kept?", answers: ["in the Labyrinth, built by Daedalus", "in a deep cave on Crete", "in the palace of King Minos", "beneath the temple of Zeus"] },
    { id: "1.4-C-32", subtopic: "Theseus: the labours (the Kylix)", q: "Why did Theseus go to Crete?", answers: ["he volunteered to be one of the sacrificial youths", "he was captured in battle by King Minos", "his father Aegeus had ordered him to", "he went there in order to marry Ariadne"] },
    { id: "1.4-C-33", subtopic: "Theseus: the labours (the Kylix)", q: "What happened to Ariadne after the escape from Crete?", answers: ["she was left behind on the island of Naxos", "she married Theseus back in Athens", "she returned to her home on Crete", "she was killed by the dying Minotaur"] },
