...
const laboursData = [
    {
        ...
        narrative: [
            "A monstrous lion terrorised the region of Nemea, devouring livestock and humans alike. This was no ordinary beast - it was the offspring of the monsters Typhon and Echidna, with a golden hide that no weapon could pierce. The lion had made its lair in a cave with two entrances, from which it would emerge to devastate the countryside.",
            "When Heracles arrived, he first tried his arrows, but they bounced harmlessly off the golden fur. His sword bent when he struck the beast, and his club shattered against its skull. Realising conventional weapons were useless, Heracles cornered the lion in its cave, blocked one entrance, and entered through the other.",
    ...
    },
    {
        ...
        narrative: [
            "In the swamps of Lerna lurked a serpentine horror - the Hydra, another child of Typhon and Echidna. This water snake had nine heads (some say more), with the central head being immortal. Its breath and blood were deadly poison, and it had been raised by Hera specifically to kill Heracles.",
            "Heracles arrived with his nephew Iolaus as his charioteer. He forced the Hydra from its lair by shooting flaming arrows into the swamp. As they fought, Heracles discovered the creature's terrible secret - when he cut off one head, two more grew in its place. To make matters worse, Hera sent a giant crab to attack Heracles' feet (which he crushed, and which became the constellation Cancer).",
    ...
    },
    {
        ...
        narrative: [
            "The Ceryneian Hind was no ordinary deer. Sacred to Artemis, goddess of the hunt, it possessed golden antlers and bronze hooves, and could run faster than an arrow in flight. Eurystheus chose this labour hoping either that Heracles would fail to catch such a swift creature, or that he would anger Artemis by capturing her sacred animal.",
            "Heracles pursued the hind for an entire year. Through summer heat and winter snow, across mountains and valleys, the chase continued. The hind led him far north, even to the land of the Hyperboreans beyond the north wind. Some say Heracles finally caught it when it paused to drink at the river Ladon; others that he waited until it was exhausted and sleeping.",
    ...
    },
    {
        ...
        narrative: [
            "On the slopes of Mount Erymanthus lived a monstrous boar that ravaged the countryside of Arcadia. Its tusks were like swords, its hide thick as armour, and its temper so fierce that hunters fled at the mere sound of its approach. Eurystheus commanded that this beast be brought back alive.",
            "On his way to Mount Erymanthus, Heracles stopped to visit his friend Pholus, a civilised centaur. When Heracles asked for wine, Pholus opened a jar that belonged to all centaurs collectively. The scent attracted the other centaurs, who attacked in fury. Heracles defended himself with his poisoned arrows, accidentally wounding his friend Chiron, the immortal centaur teacher. The poison caused Chiron such agony that he later gave up his immortality to escape the pain.",
    ...
    },
    {
        ...
        narrative: [
            "King Augeas of Elis owned more cattle than any other man on earth - three thousand oxen, including twelve prize bulls that were white as snow and dedicated to Helios, the sun god. These vast herds had been kept in stables that hadn't been cleaned for thirty years. The filth was piled so high that it had become impossible to enter, and the stench poisoned the air for miles around. Eurystheus, believing this task impossible to complete in a single day, ordered Heracles to clean the stables.",
            "Heracles went to King Augeas and, without mentioning Eurystheus, offered to clean the stables in a single day in exchange for one-tenth of the cattle. Augeas laughed at the impossible boast and readily agreed, even calling his son Phyleus as a witness to the bargain. Heracles then made two great breaches in the stable walls and diverted the courses of two rivers - the Alpheus and the Peneus.",
    ...
    },
    {
        ...
        narrative: [
            "Lake Stymphalia was surrounded by dense forests and marshes, the perfect hiding place for a flock of man-eating birds. These were no ordinary creatures - they had beaks of bronze that could pierce armour, metallic feathers they could launch like arrows, and their toxic dung poisoned the land and water. Sacred to Ares, god of war, they had multiplied until they darkened the sky in flight, terrorising the entire region.",
            "When Heracles arrived at the lake, he found the task more difficult than expected. The marshy ground wouldn't support his weight to reach the birds, and they hid deep in the thick forest where his arrows couldn't reach them. He stood at the lake's edge, frustrated by this seemingly simple task that had become impossible.",
    ...
    },
    {
        ...
        location: "Crete",
        narrative: [
            "The Cretan Bull had a divine origin. King Minos of Crete had prayed to Poseidon to send him a sign of favour - a bull from the sea that he would then sacrifice back to the god. Poseidon sent a magnificent white bull, so beautiful that Minos couldn't bear to kill it. He sacrificed another bull instead, keeping the divine one for himself. In punishment, Poseidon made the bull savage and caused Minos' wife Pasiphaë to fall in love with it - a union that would produce the Minotaur.",
            "By the time Heracles arrived, the bull was ravaging Crete, breathing fire, uprooting crops, and destroying orchard walls. The creature had become a terror that no one could approach. Minos, perhaps relieved to be rid of this reminder of his family's shame, gave Heracles permission to take the bull if he could.",
    ...
    },
    {
        ...
        location: "Thrace",
        narrative: [
            "King Diomedes of Thrace, son of Ares and Cyrene, ruled the warlike Bistones. He owned four mares - Podargos (swift), Lampon (shining), Xanthos (yellow), and Deinos (terrible) - magnificent creatures with one horrifying trait: they were fed on human flesh. Diomedes kept them tethered with iron chains to bronze mangers, feeding them the flesh of unsuspecting guests and strangers who came to his palace. The horses had become so savage that they breathed fire and their madness was infectious.",
            "Heracles sailed to Thrace with a band of volunteers, including his beloved companion Abderus. They overpowered the grooms and led the mares toward the sea. When Diomedes and his men pursued them, Heracles left Abderus to guard the horses while he fought. He defeated the Bistones and captured Diomedes alive.",
    ...
    },
    {
        ...
        narrative: [
            "Eurystheus' daughter Admete desired the golden belt of Hippolyta, Queen of the Amazons. This was no ordinary ornament - it was a gift from Ares, god of war, to his daughter, symbolising her authority as queen of the warrior women. The Amazons were a nation of female warriors who lived without men, meeting neighbouring tribes only to produce children, keeping the girls and sending away the boys.",
            "Heracles sailed to Themiscyra on the Black Sea with a crew of heroes, including Theseus. When they arrived, Queen Hippolyta herself came to meet them at their ship. Surprisingly, she was impressed by Heracles' fame and bearing. When he explained his mission, she agreed to give him the belt as a gift of respect between warriors.",
    ...
    },
    {
        ...
        narrative: [
            "Geryon was a monster with three heads, three bodies joined at the waist, and six arms. He lived on the island of Erytheia, far in the western ocean beyond the edge of the known world. There he kept a herd of magnificent red cattle, guarded by the herdsman Eurytion and the two-headed dog Orthrus, brother of Cerberus. To reach this distant land, Heracles had to journey to the very edge of the world.",
            "When Heracles reached the straits that separate Europe from Africa, he set up two great pillars to mark his journey - the Pillars of Heracles (modern Gibraltar). The heat of the sun in these southern lands was so intense that Heracles, in frustration, shot an arrow at Helios. The sun god, admiring his boldness, lent him his golden cup - the vessel in which Helios sailed each night from west to east. In this magical boat, Heracles sailed to Erytheia.",
    ...
    },
    {
        ...
        icon: "🍎",
        region: "supernatural",
        location: "Garden of the Hesperides, far west beyond the sunset",
        narrative: [
            "The golden apples grew in a garden at the western edge of the world, where the Titan Atlas held up the sky. These apples were a wedding gift from Gaia to Hera when she married Zeus, and were tended by the Hesperides, daughters of the evening, and guarded by Ladon, an immortal dragon with a hundred heads that never slept. The location of this garden was a closely guarded secret.",
            "Heracles first had to find the garden. He wrestled the sea-god Nereus, the Old Man of the Sea, who could change his shape. Though Nereus transformed into fire, water, and many animals, Heracles held tight until the god revealed the location. The journey took Heracles through Libya, Egypt (where he killed the king Busiris who tried to sacrifice him), and to the Caucasus Mountains where he freed Prometheus from his eternal torment, killing the eagle that daily devoured his liver.",
    ...
    },
    {
        ...
        narrative: [
            "For his final labour, Eurystheus demanded the impossible: bring back Cerberus, the three-headed hellhound that guarded the gates of the Underworld, preventing the dead from leaving and the living from entering. This was a journey from which no mortal had ever returned. Cerberus had three dog heads, a serpent for a tail, and snakes growing from his back.",
            "To prepare for this ultimate challenge, Heracles first traveled to Eleusis to be initiated into the Eleusinian Mysteries, sacred rites that promised initiates a blessed afterlife. This spiritual preparation was essential for a living man entering the realm of the dead. Guided by Hermes and Athena, Heracles descended through the cave at Taenarum in Laconia.",
            "In the Underworld, the shades of the dead fled before him, all except the hero Meleager and the Gorgon Medusa. Heracles drew his sword against Medusa, but Hermes reminded him she was now just an empty phantom. He freed Theseus, who had been imprisoned for trying to kidnap Persephone, though Pirithous remained trapped forever. When Heracles reached the throne of Hades and Persephone, he asked permission to take Cerberus. Hades agreed on one condition: Heracles must subdue the beast using no weapons, only his bare hands.",
